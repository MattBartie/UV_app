                ...
                child: Column(
                  children: [
                    if (vm.isLoading)
                      ...
                      // FIX 1: Wrap the UV Number to handle large text
                      SizedBox(
                        height: 100, 
                        width: 300,
                        child: FittedBox(
              ...
              Center(
                child: Stack(
                  ...
                  children: [
                    ...
                    // FIX 2: Constrain BOTH Number and Label to fit inside the circle
                    SizedBox(
                      width: 140, 
                      height: 140,
                      child: FittedBox(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            const Text("SAFE TIME", style: TextStyle(color: Colors.white70, fontSize: 14)),
                          ],
                        ),
                      ),
                    )
